...
//		console.log("St 1",interval, schedule[interval.start]);
		schedule[interval.start]++;
//		console.log("St 2",interval, schedule[interval.start]);
		
		schedule[interval.end] = schedule[interval.end] || 0;
//		console.log("End 1",interval, schedule[interval.end]);
		schedule[interval.end]--;
//		console.log("End 2",interval, schedule[interval.end]);
	});
	var maxRooms = 0;
	var rooms = 0;
